# USE CASE: 10 Produce a Report on the population of cities in a country from largest to smallest

## CHARACTERISTIC INFORMATION

### Goal in Context

As an urban city planner, I need a list of all the cities in a country organised by largest population to smallest to assist with the development of housing.
