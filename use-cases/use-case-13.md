...
As an urban city planner, I need a list of the top N populated cities in a continent where N is provided by the user to assist with the development of housing.
