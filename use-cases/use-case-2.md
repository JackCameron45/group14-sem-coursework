# USE CASE: 2 Produce a Report on the population of countries in a continent from largest to smallest

## CHARACTERISTIC INFORMATION

### Goal in Context

As students of the SEM module we need list of all the countries in a continent organised by largest population to smallest.
