# USE CASE: 19 Produce a Report on the population of capital cities in a region from largest to smallest

## CHARACTERISTIC INFORMATION

### Goal in Context

As an urban city planner, I need a list of all the capital cities in a region organised by largest to smallest to assist with the development of housing.
