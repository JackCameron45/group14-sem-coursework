# USE CASE: 9 Produce a Report on the population of cities in a region from largest to smallest

## CHARACTERISTIC INFORMATION

### Goal in Context

As an urban city planner, I need a list of all the cities in a region organised by largest population to smallest to assist with the development of housing.
